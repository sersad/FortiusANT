...
class frmFortiusAntGui(wx.Frame):
    ...
    def __init__(self, parent, pclv):
        ...
        if True:
            ...
            self.Speed.SetAngleRange(-math.pi / 6,
                                     7 * math.pi / 6)  # Set The Region Of Existence Of self.SpeedMeter (Always In Radians!!!!)
            ...
            self.Speed.SetMiddleTextFont(
                wx.Font(MiddleTextFontSize, wx.FONTFAMILY_SWISS, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_BOLD))
            ...
            intervals = range(Min, Max + 1,
                              Step)  # Create The Intervals That Will Divide Our self.SpeedMeter In Sectors
            ...
            ticks = [str(interval) for interval in
                     intervals]  # Assign The Ticks: Here They Are Simply The String Equivalent Of The Intervals
            ...
            self.Speed.SetTicksFont(
                wx.Font(TicksFontSize, wx.FONTFAMILY_SWISS, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL))
        ...
        if True:
            ...
            self.Revs.SetAngleRange(-math.pi / 6,
                                    7 * math.pi / 6)  # Set The Region Of Existence Of self.RevsMeter (Always In Radians!!!!)
        ...
        if True:
            ...
            self.Power.SetAngleRange(-math.pi / 6,
                                     7 * math.pi / 6)  # Set The Region Of Existence Of self.PowerMeter (Always In Radians!!!!)
        ...
        # ----------------------------------------------------------------------
        self.txtSpeed = wx.TextCtrl(self.Speed, value="99.9", size=(int(TextCtrlW * 1.2), TextCtrlH),
                                    style=wx.TE_CENTER | wx.TE_READONLY | wx.BORDER_NONE)
        self.txtSpeed.SetBackgroundColour(bg)
        self.txtSpeed.SetPosition(
            (int((self.Speed.Width - self.txtSpeed.Size[0]) / 2), self.Speed.Height - self.txtSpeed.Size[1]))

        # ----------------------------------------------------------------------
        # self.Revs value;  (On top of self.Revs)
        # ----------------------------------------------------------------------
        self.txtRevs = wx.TextCtrl(self.Revs, value="999/min", size=(int(TextCtrlW * 1.2), TextCtrlH),
                                   style=wx.TE_CENTER | wx.TE_READONLY | wx.BORDER_NONE)
        self.txtRevs.SetBackgroundColour(bg)
        self.txtRevs.SetPosition(
            (int((self.Revs.Width - self.txtRevs.Size[0]) / 2), self.Revs.Height - self.txtRevs.Size[1]))

        # ----------------------------------------------------------------------
        # self.Power values; (On top of self.Power)
        # ----------------------------------------------------------------------
        self.txtPower = wx.TextCtrl(self.Power, value="999 Watt", size=(TextCtrlW, TextCtrlH),
                                    style=wx.TE_CENTER | wx.TE_READONLY | wx.BORDER_NONE)
        self.txtPower.SetBackgroundColour(bg)
        self.txtPower.SetPosition(
            (int((self.Power.Width - self.txtPower.Size[0]) / 2), self.Power.Height - 2 * self.txtPower.Size[1]))

        self.txtTarget = wx.TextCtrl(self.Power, value="Target=999 Watt", size=(int(TextCtrlW * 1.3), TextCtrlH),
        ...
        self.txtTacx = wx.TextCtrl(self.Power, value="Tacx=9999", size=(int(TextCtrlW * 0.7), TextCtrlH),
        ...
        # ----------------------------------------------------------------------
        self.txtHeartRate = wx.TextCtrl(self.panel, value="123", size=(int(self.HeartRateWH * 2), TextCtrlH),
        ...
        # ----------------------------------------------------------------------
        self.txtCranckset = wx.TextCtrl(self.panel, value="456", size=(int(self.CrancksetWH * 2), TextCtrlH),
                                        style=wx.TE_CENTER | wx.TE_READONLY)
        ...
        # ----------------------------------------------------------------------
        self.txtCassette = wx.TextCtrl(self.panel, value="789", size=(int(self.CassetteWH * 2), TextCtrlH),
                                       style=wx.TE_CENTER | wx.TE_READONLY)
    ...
    def callRunoff(self):
        ...
        while self.RunningSwitch == True:
            t = time.localtime()
            f += 1
            self.SetValues(f / 100 * self.SpeedMax, f / 100 * self.RevsMax, f / 100 * self.PowerMax, t[5], False,
                           t[0] + t[5], 123, 10, random.randint(0, 2), random.randint(0, 12), 1)
        ...
        while self.RunningSwitch == True:
            ...
            if FixedForDocu:  # Fixed value for documentation screen
                ...
                self.SetValues(r * 35.6, r * 234, r * 123, mode_Grade, r * 345, r * 19.5, r * 2345, r * 123,
                               random.randint(0, 1), random.randint(0, 12), 1)
